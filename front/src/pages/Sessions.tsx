    ...
    <div className="max-w-3xl mx-auto py-8 px-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-md bg-[var(--color-accent)] text-[var(--color-accent-foreground)] text-sm hover:bg-[var(--color-accent-hover)] transition-colors"
        >
          <Plus size={16} />
          {t('chat.newSession')}
        </button>
        ...
        <EmptyState
          ...
          action={
            <button
              ...
              className="px-4 py-2 text-sm rounded-md bg-[var(--color-accent)] text-[var(--color-accent-foreground)]"
            >
              {t('chat.newSession')}
            </button>
          }
