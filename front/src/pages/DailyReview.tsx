          ...
          {!showQuiz ? (
            ...
            <div className="bg-[var(--color-card)] rounded-lg border border-[var(--color-border)] p-6 space-y-4">
              ...
              {showResult && currentIndex >= items.length - 1 && (
                <button
                  onClick={handleDoneThenNext}
                  className="w-full flex items-center justify-center gap-2 px-4 py-2.5 text-sm rounded-md bg-[var(--color-accent)] text-[var(--color-accent-foreground)] hover:bg-[var(--color-accent-hover)] transition-colors"
                >
