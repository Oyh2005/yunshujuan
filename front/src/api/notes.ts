...
import type { ApiResponse, BacklinksData, DeleteCategoryResponse, GraphData, Note, NoteListResponse, NoteStats, RelatedFragment } from '../types/api'
...
export const notesApi = {
  ...
  backlinks: async (id: string) => {
    const res = await client.get<ApiResponse<BacklinksData>>(endpoints.noteBacklinks(id))
    return res.data
  },
